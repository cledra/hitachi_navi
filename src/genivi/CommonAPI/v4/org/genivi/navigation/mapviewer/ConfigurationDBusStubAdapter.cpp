...
*/
#include <v4/org/genivi/navigation/mapviewer/Configuration.hpp>
#include <v4/org/genivi/navigation/mapviewer/ConfigurationDBusStubAdapter.hpp>
 ...
 *   configuration settings changes
 */
void ConfigurationDBusStubAdapterInternal::fireConfigurationChangedEvent(const std::vector<::v4::org::genivi::navigation::mapviewer::Configuration::Settings>& changedSettings) {
    CommonAPI::DBus::DBusStubSignalHelper<CommonAPI::DBus::DBusSerializableArguments<
    CommonAPI::Deployable<std::vector<::v4::org::genivi::navigation::mapviewer::Configuration::Settings>, CommonAPI::DBus::ArrayDeployment<CommonAPI::EmptyDeployment>>
    >>::sendSignal(
            *this,
            "configurationChanged",
            "ai",
    CommonAPI::Deployable<std::vector<::v4::org::genivi::navigation::mapviewer::Configuration::Settings>, CommonAPI::DBus::ArrayDeployment<CommonAPI::EmptyDeployment>>(changedSettings, static_cast<CommonAPI::DBus::ArrayDeployment<CommonAPI::EmptyDeployment>*>(nullptr))
    );
}
...
ConfigurationDBusStubAdapterInternal::ConfigurationDBusStubAdapterInternal(
	...
	: CommonAPI::DBus::DBusStubAdapter(_address, _connection,false),
      ...
      stubDispatcherTable_({
             ...
             * description: This method returns the API version .
             */
            { { "getVersion", "" }, &org::genivi::navigation::mapviewer::ConfigurationDBusStubAdapterInternal::getVersionStubDispatcher },
            /**
             * description: Set the current language set. If the language is not supported, the default
             *   details will be returned in the native language.
             */
            { { "setLocale", "sss" }, &org::genivi::navigation::mapviewer::ConfigurationDBusStubAdapterInternal::setLocaleStubDispatcher },
            /**
             * description: Get the current language set .
             */
            { { "getLocale", "" }, &org::genivi::navigation::mapviewer::ConfigurationDBusStubAdapterInternal::getLocaleStubDispatcher },
            /**
             * description: Get the supported set of locales .
             */
            { { "getSupportedLocales", "" }, &org::genivi::navigation::mapviewer::ConfigurationDBusStubAdapterInternal::getSupportedLocalesStubDispatcher },
            /**
             * description: Set the time format.
             */
            { { "setTimeFormat", "i" }, &org::genivi::navigation::mapviewer::ConfigurationDBusStubAdapterInternal::setTimeFormatStubDispatcher },
            /**
             * description: Get the current time format .
             */
            { { "getTimeFormat", "" }, &org::genivi::navigation::mapviewer::ConfigurationDBusStubAdapterInternal::getTimeFormatStubDispatcher },
            /**
             * description: Get the supported set of time format .
             */
            { { "getSupportedTimeFormats", "" }, &org::genivi::navigation::mapviewer::ConfigurationDBusStubAdapterInternal::getSupportedTimeFormatsStubDispatcher },
            /**
             * description: Set the coordinates format.
             */
            { { "setCoordinatesFormat", "i" }, &org::genivi::navigation::mapviewer::ConfigurationDBusStubAdapterInternal::setCoordinatesFormatStubDispatcher },
            /**
             * description: Get the coordinates format .
             */
            { { "getCoordinatesFormat", "" }, &org::genivi::navigation::mapviewer::ConfigurationDBusStubAdapterInternal::getCoordinatesFormatStubDispatcher },
            /**
             * description: Get the supported set of coordinates format .
             */
            { { "getSupportedCoordinatesFormat", "" }, &org::genivi::navigation::mapviewer::ConfigurationDBusStubAdapterInternal::getSupportedCoordinatesFormatStubDispatcher },
            /**
             * description: Set the units of measurement .
             */
            { { "setUnitsOfMeasurement", "a{ii}" }, &org::genivi::navigation::mapviewer::ConfigurationDBusStubAdapterInternal::setUnitsOfMeasurementStubDispatcher },
            /**
             * description: Get the units of measurement .
             */
            { { "getUnitsOfMeasurement", "" }, &org::genivi::navigation::mapviewer::ConfigurationDBusStubAdapterInternal::getUnitsOfMeasurementStubDispatcher },
            /**
             * description: Get the supported set of units of measurement .
             */
            { { "getSupportedUnitsOfMeasurement", "" }, &org::genivi::navigation::mapviewer::ConfigurationDBusStubAdapterInternal::getSupportedUnitsOfMeasurementStubDispatcher }
            }),
        stubAttributeTable_() {

    stubDispatcherTable_.insert({ { "getInterfaceVersion", "" }, &org::genivi::navigation::mapviewer::ConfigurationDBusStubAdapterInternal::getConfigurationInterfaceVersionStubDispatcher });
}
