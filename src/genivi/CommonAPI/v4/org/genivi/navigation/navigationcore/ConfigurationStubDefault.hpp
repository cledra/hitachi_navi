 ...
 */
#ifndef V4_ORG_GENIVI_NAVIGATION_NAVIGATIONCORE_Configuration_STUB_DEFAULT_HPP_
#define V4_ORG_GENIVI_NAVIGATION_NAVIGATIONCORE_Configuration_STUB_DEFAULT_HPP_
 ...
 */
virtual void fireConfigurationChangedEvent(const std::vector<::v4::org::genivi::navigation::navigationcore::Configuration::Settings> &_changedSettings);
...
#endif // V4_ORG_GENIVI_NAVIGATION_NAVIGATIONCORE_Configuration_STUB_DEFAULT
