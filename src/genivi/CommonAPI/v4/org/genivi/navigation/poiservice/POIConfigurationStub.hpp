 ...
 */
#ifndef V4_ORG_GENIVI_NAVIGATION_POISERVICE_POI_Configuration_STUB_HPP_
#define V4_ORG_GENIVI_NAVIGATION_POISERVICE_POI_Configuration_STUB_HPP_
 ...
 * to a stub for the service POIConfiguration. Also provides means to send broadcasts
 * and attribute-changed-notifications of observable attributes as defined by this service.
 * An application developer should not need to bother with this class.
 */
class POIConfigurationStubAdapter
    : public virtual CommonAPI::StubAdapter, 
      public virtual POIConfiguration {
 public:
 ...
 * defined in the IDL description for POIConfiguration.
 ...
 */
class POIConfigurationStubRemoteEvent
{
public:
    virtual ~POIConfigurationStubRemoteEvent() { }

};

/**
 * Defines the interface that must be implemented by any class that should provide
 * the service POIConfiguration to remote clients.
 * This class and the one above are the ones an application developer needs to have
 * a look at if he wants to implement a service.
 */
class POIConfigurationStub
    : public virtual CommonAPI::Stub<POIConfigurationStubAdapter, POIConfigurationStubRemoteEvent>
{
public:
    ...
    typedef std::function<void (POIConfiguration::CoordinatesFormat _coordinatesFormat)>getCoordinatesFormatReply_t;
    typedef std::function<void (std::vector<POIConfiguration::CoordinatesFormat> _coordinatesFormatList)>getSupportedCoordinatesFormatReply_t;
    typedef std::function<void ()>setUnitsOfMeasurementReply_t;
    typedef std::function<void (POIConfiguration::UnitsOfMeasurement _unitsOfMeasurementList)>getUnitsOfMeasurementReply_t;
    typedef std::function<void (POIConfiguration::UnitsOfMeasurement _unitsOfMeasurementList)>getSupportedUnitsOfMeasurementReply_t;

    virtual ~POIConfigurationStub() {}
    ...
    virtual void setCoordinatesFormat(const std::shared_ptr<CommonAPI::ClientId> _client, POIConfiguration::CoordinatesFormat _coordinatesFormat, setCoordinatesFormatReply_t _reply) = 0;
    /**
    ...
    virtual void setUnitsOfMeasurement(const std::shared_ptr<CommonAPI::ClientId> _client, POIConfiguration::UnitsOfMeasurement _unitsOfMeasurementList, setUnitsOfMeasurementReply_t _reply) = 0;
    /**
    ...
    using CommonAPI::Stub<POIConfigurationStubAdapter, POIConfigurationStubRemoteEvent>::initStubAdapter;
    typedef CommonAPI::Stub<POIConfigurationStubAdapter, POIConfigurationStubRemoteEvent>::StubAdapterType StubAdapterType;
    typedef CommonAPI::Stub<POIConfigurationStubAdapter, POIConfigurationStubRemoteEvent>::RemoteEventHandlerType RemoteEventHandlerType;
    typedef POIConfigurationStubRemoteEvent RemoteEventType;
    typedef POIConfiguration StubInterface;
};
...
#endif // V4_ORG_GENIVI_NAVIGATION_POISERVICE_POI_Configuration_STUB_HPP_
