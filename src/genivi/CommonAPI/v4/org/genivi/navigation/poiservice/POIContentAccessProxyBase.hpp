 ...
 */
#ifndef V4_ORG_GENIVI_NAVIGATION_POISERVICE_POI_Content_Access_PROXY_BASE_HPP_
#define V4_ORG_GENIVI_NAVIGATION_POISERVICE_POI_Content_Access_PROXY_BASE_HPP_
...
class POIContentAccessProxyBase
    : virtual public CommonAPI::Proxy {
public:

    typedef std::function<void(const CommonAPI::CallStatus&, const ::v4::org::genivi::navigation::poiservice::POIServiceTypes::ContentAccessModuleID&)> RegisterContentAccessModuleAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&)> UnRegisterContentAccessModuleAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&)> RegisterPoiCategoriesAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&)> UpdateCategoriesAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const std::vector<::v4::org::genivi::CommonTypes::CategoryID>&)> AddCategoriesAsyncCallback;
     ...
     */
    virtual void registerContentAccessModule(const std::string &_moduleName, CommonAPI::CallStatus &_internalCallStatus, ::v4::org::genivi::navigation::poiservice::POIServiceTypes::ContentAccessModuleID &_camId, const CommonAPI::CallInfo *_info = nullptr) = 0;
    virtual std::future<CommonAPI::CallStatus> registerContentAccessModuleAsync(const std::string &_moduleName, RegisterContentAccessModuleAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr) = 0;
    /**
     * description: Remove CAM from POI provider module.
     */
    virtual void unRegisterContentAccessModule(const ::v4::org::genivi::navigation::poiservice::POIServiceTypes::ContentAccessModuleID &_camId, CommonAPI::CallStatus &_internalCallStatus, const CommonAPI::CallInfo *_info = nullptr) = 0;
    virtual std::future<CommonAPI::CallStatus> unRegisterContentAccessModuleAsync(const ::v4::org::genivi::navigation::poiservice::POIServiceTypes::ContentAccessModuleID &_camId, UnRegisterContentAccessModuleAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr) = 0;
    /**
     ...
     */
    virtual void registerPoiCategories(const ::v4::org::genivi::navigation::poiservice::POIServiceTypes::ContentAccessModuleID &_camId, const std::vector<::v4::org::genivi::CommonTypes::CategoryID> &_poiCategories, CommonAPI::CallStatus &_internalCallStatus, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     */
    virtual void updateCategories(const ::v4::org::genivi::navigation::poiservice::POIServiceTypes::ContentAccessModuleID &_camId, const std::vector<::v4::org::genivi::navigation::poiservice::POIServiceTypes::CAMCategoryUpdate> &_poiCategories, CommonAPI::CallStatus &_internalCallStatus, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     */
    virtual void removeCategories(const ::v4::org::genivi::navigation::poiservice::POIServiceTypes::ContentAccessModuleID &_camId, const std::vector<::v4::org::genivi::CommonTypes::CategoryID> &_poiCategories, CommonAPI::CallStatus &_internalCallStatus, const CommonAPI::CallInfo *_info = nullptr) = 0;
...
#endif // V4_ORG_GENIVI_NAVIGATION_POISERVICE_POI_Content_Access_PROXY_BASE_HPP_
