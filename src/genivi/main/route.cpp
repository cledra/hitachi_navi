...
unsigned char   demo_disp_info[ICON_CNT_MAX];	// ユーザ定義ダイナミックアイコンデータの表示/非表示
...
int sample_calc_demo_route(DisplayContext &ctxDisplay)
{
	SMCARSTATE carState;
	INT32		ret;
	...
	//ctxHmi.sample_hmi_set_pin_mode(0);
    //ctxHmi.set_pin = 0;
    ctxDisplay.hmi.set_pin = 0;
