 ...
 */
#ifndef V4_ORG_GENIVI_NAVIGATION_MAPVIEWER_Configuration_PROXY_BASE_HPP_
#define V4_ORG_GENIVI_NAVIGATION_MAPVIEWER_Configuration_PROXY_BASE_HPP_
...
public:
    typedef CommonAPI::Event<
        std::vector<::v4::org::genivi::navigation::mapviewer::Configuration::Settings>
    ...
    typedef std::function<void(const CommonAPI::CallStatus&, const Configuration::CoordinatesFormat&)> GetCoordinatesFormatAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const std::vector<Configuration::CoordinatesFormat>&)> GetSupportedCoordinatesFormatAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&)> SetUnitsOfMeasurementAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const Configuration::UnitsOfMeasurement&)> GetUnitsOfMeasurementAsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&, const Configuration::UnitsOfMeasurementList&)> GetSupportedUnitsOfMeasurementAsyncCallback;
     ...
     */
    virtual void setCoordinatesFormat(const Configuration::CoordinatesFormat &_coordinatesFormat, CommonAPI::CallStatus &_internalCallStatus, const CommonAPI::CallInfo *_info = nullptr) = 0;
    virtual std::future<CommonAPI::CallStatus> setCoordinatesFormatAsync(const Configuration::CoordinatesFormat &_coordinatesFormat, SetCoordinatesFormatAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr) = 0;
    /**
     * description: Get the coordinates format .
     */
    virtual void getCoordinatesFormat(CommonAPI::CallStatus &_internalCallStatus, Configuration::CoordinatesFormat &_coordinatesFormat, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     */
    virtual void getSupportedCoordinatesFormat(CommonAPI::CallStatus &_internalCallStatus, std::vector<Configuration::CoordinatesFormat> &_coordinatesFormatList, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     */
    virtual void setUnitsOfMeasurement(const Configuration::UnitsOfMeasurement &_unitsOfMeasurement, CommonAPI::CallStatus &_internalCallStatus, const CommonAPI::CallInfo *_info = nullptr) = 0;
    virtual std::future<CommonAPI::CallStatus> setUnitsOfMeasurementAsync(const Configuration::UnitsOfMeasurement &_unitsOfMeasurement, SetUnitsOfMeasurementAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr) = 0;
    /**
     * description: Get the units of measurement .
     */
    virtual void getUnitsOfMeasurement(CommonAPI::CallStatus &_internalCallStatus, Configuration::UnitsOfMeasurement &_unitsOfMeasurement, const CommonAPI::CallInfo *_info = nullptr) = 0;
     ...
     */
    virtual void getSupportedUnitsOfMeasurement(CommonAPI::CallStatus &_internalCallStatus, Configuration::UnitsOfMeasurementList &_unitsOfMeasurementList, const CommonAPI::CallInfo *_info = nullptr) = 0;
...
#endif // V4_ORG_GENIVI_NAVIGATION_MAPVIEWER_Configuration_PROXY_BASE_HPP_
